...
public: // should be protected, but some old compilers complain otherwise
  ...
  protected:
    ...
    Boolean jvAuthenticationOK(const char* fullRequestStr);
  ...
  class RTSPClientSession {
	  RTSPClientConnection* m_clientConnection; // Used for Delete Connection when Session timeout. lfx@jovision.com
  public:
