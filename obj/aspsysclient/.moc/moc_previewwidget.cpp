...
#include "../../../src/aspsysclient/previewwidget.h"
...
QT_MOC_LITERAL(1, 14, 21), // "signalMainViewClicked"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 23) // "signalToggleMainSubView"

    },
    "PreviewWidget\0signalMainViewClicked\0"
    "\0signalToggleMainSubView"
};
...
void PreviewWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->signalMainViewClicked(); break;
        case 1: _t->signalToggleMainSubView(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PreviewWidget::signalMainViewClicked)) {
                *result = 0;
            }
        }
        {
            typedef void (PreviewWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PreviewWidget::signalToggleMainSubView)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void PreviewWidget::signalMainViewClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void PreviewWidget::signalToggleMainSubView()
{
